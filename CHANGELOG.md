...
* Activate release so i can test ([34b7227](https://github.com/Vagelis1608/piko/commit/34b7227934bc77e024d37ae5f14b719a9d165288))
* add "SettingsStatusLoadFingerprint" to fingerprints of `Hide Community Notes` and `Hide Live Threads` patch ([9c0232a](https://github.com/Vagelis1608/piko/commit/9c0232afd684024cc7028960aa2c65a82ce90cb7))
* Add back settings for the custom sharemenu buttons ([bc7e777](https://github.com/Vagelis1608/piko/commit/bc7e777e59091801238d4692823415b0d7d2855b))
* Add support for 10.83.0 releases ([9344d52](https://github.com/Vagelis1608/piko/commit/9344d527d1ec5e0fd812bd835c45304a6619df95))
* Adding debug menu patch results in a crash ([caf82eb](https://github.com/Vagelis1608/piko/commit/caf82ebd95bd113dbd5cacda1deffa9194cb280b))
* **Bring back twitter:** Change the character "𝕏" into "Twitter". ([#441](https://github.com/Vagelis1608/piko/issues/441)) ([c20e16f](https://github.com/Vagelis1608/piko/commit/c20e16f80499df75176e9080f156e529f4f7d326))
* **Bring back twitter:** Change x icon to legacy twitter. ([3006f47](https://github.com/Vagelis1608/piko/commit/3006f47d973ffde1622ae1544590a11e923c68ab))
* **Bring back twitter:** Resource compilation fails on ReVanced Manager ([a364bec](https://github.com/Vagelis1608/piko/commit/a364becc7f6f70724c37b9499e79885fb09f0436))
* Change run config ([18d4dce](https://github.com/Vagelis1608/piko/commit/18d4dcebb67a568e460931c6cd2003a0df7ae5ec))
* **Custom download folder:** Restore compatibility with versions prior to 10.64 ([b88b00b](https://github.com/Vagelis1608/piko/commit/b88b00ba97632d62517c0e52a924c453ea022d7a))
* **Custom downloader:** Improve fingerprint ([2a2a4a4](https://github.com/Vagelis1608/piko/commit/2a2a4a4e2cdc6587c5c3b91bb3888918d7cd720d))
* **Custom font:** Fix crash on Android 8 by restricting the functionality to Android 9+ ([477f634](https://github.com/Vagelis1608/piko/commit/477f6345a062bc3605dd343d290734074483a61c))
* **Custom font:** Fix crash on Android 8 by restricting the functionality to Android 9+ ([000539b](https://github.com/Vagelis1608/piko/commit/000539b8b67d97b83efdf4eab2d311e9b492f167))
* **Custom sharing domain:** Now works on "Copy Link" ([8f71415](https://github.com/Vagelis1608/piko/commit/8f71415e2c7cb5cf351bbcf11d2942d5f0771995))
* **Dynamic color:** Reflect piko's original changes ([0c91cad](https://github.com/Vagelis1608/piko/commit/0c91cad6d4112a02735edc5776a136e9f7c88271))
* **Enable Reader Mode:** Specify the compatible version, show a warning instead of throwing an exception when failed ([b1c52e7](https://github.com/Vagelis1608/piko/commit/b1c52e73daabe3222e925ba5d6b866af31a35045))
* **entity:** swap username and display name method mappings in TweetEntityPatch ([b946ebf](https://github.com/Vagelis1608/piko/commit/b946ebff8b59081ad3c53eb9ed108c3695dfe5fa))
* fallback instruction address ([95f69e3](https://github.com/Vagelis1608/piko/commit/95f69e3fef4774072bb82b2717d9ba44ed8e0487))
* **Feature Flags:** Use ListView instead of RecyclerView for a more reliable list. ([6f16b7f](https://github.com/Vagelis1608/piko/commit/6f16b7f7d61c81e7a21394f74b6e0d0e80ed9a55))
* Fix crash when opening feature flags ([2b1484d](https://github.com/Vagelis1608/piko/commit/2b1484d6c291a997283d98358cff98b0195acfed))
* Fix oopsie ([2af661f](https://github.com/Vagelis1608/piko/commit/2af661f5dfa1cc08e436ce04800ab230030a5079))
* fix webview resource id ([6c1c81d](https://github.com/Vagelis1608/piko/commit/6c1c81d057f3bee73ed8fb53cc95665b89e9c973))
* **Hide FAB:** Add description ([ae418a8](https://github.com/Vagelis1608/piko/commit/ae418a83d94cbb1091ba9fec3ce07a8704ab5c00))
* **Hide For You:** Included by default ([3b51053](https://github.com/Vagelis1608/piko/commit/3b51053658847d9d4d1864c5664c5247dd029bcf))
* **i18n:** complete and improve French translation for dev/v3 ([8497136](https://github.com/Vagelis1608/piko/commit/8497136d42582c801922087161e22f7ed0076021))
* idk ([0a4ade0](https://github.com/Vagelis1608/piko/commit/0a4ade0e4cf65078cfbdde349c8f7ee92754067f))
* Improve getUsername fingerprint ([af617af](https://github.com/Vagelis1608/piko/commit/af617af523bfa7df00a232a51364ea9e8ea4d34f))
* **instagram/entity:** check-cast Object arg before IgdsButton.setStyle ([7f7b605](https://github.com/Vagelis1608/piko/commit/7f7b605de6d0e36a23d4413c6876f7e48b16e5c3))
* **instagram/story:** declare StoryButton.storyButtonAction static ([24d435e](https://github.com/Vagelis1608/piko/commit/24d435eb15e9598912af101bfd161372801d9143))
* **instagram/story:** pair long arg with consecutive /range register in emitted invoke ([d65b339](https://github.com/Vagelis1608/piko/commit/d65b339b0d01705a2b5b837b3e7b6f601a73e742))
* **Instagram:** `Download media` fingerprint ([e161d4e](https://github.com/Vagelis1608/piko/commit/e161d4ed0eafb3a7d802c1ac3d20ed176ede797d))
* **Instagram:** `Hide suggested content` patch fingerprint ([fdb7a1f](https://github.com/Vagelis1608/piko/commit/fdb7a1fc72287a9d509c749b3a9bb58e4a8633ea))
* **Instagram:** `Remove build expired popup` patch yet again ([33378d1](https://github.com/Vagelis1608/piko/commit/33378d13a7aff3c52160190c1d474884c205df78))
* **Instagram:** `Sanitize share links` patch fingerprint ([339d6b0](https://github.com/Vagelis1608/piko/commit/339d6b0f58245af830c72ef89f27d87ac3aa3f92))
* **Instagram:** download all carousel media ([2f93f78](https://github.com/Vagelis1608/piko/commit/2f93f786eb25b6186b0a2657b6eb75b52a405f33))
* **Instagram:** Fix `Change like animation` patch ([a9dacb2](https://github.com/Vagelis1608/piko/commit/a9dacb2a15bc7a502d3931f0fb8ec5e13bc05d61))
* **Instagram:** fix `Follow back indicator` patch ([ef6dfdf](https://github.com/Vagelis1608/piko/commit/ef6dfdfec9d1a89d5289c26f1b942f2f7da757ad))
* **Instagram:** fix `Improve image viewing` patch ([5655756](https://github.com/Vagelis1608/piko/commit/5655756526bbad2588db7fefcb0641d1470aa251))
* **Instagram:** Fix `Make ephemeral media permanent` patch ([fc22c94](https://github.com/Vagelis1608/piko/commit/fc22c94eb323fbc5ce12591e4a06c2dd4e590a88))
* **Instagram:** fix `Media` fingerprints again ([1fdaa80](https://github.com/Vagelis1608/piko/commit/1fdaa80a8761fdc25f5ee33e61860fd800dcf2c3))
* **Instagram:** Fix `Open links externally` patch ([b5aa5da](https://github.com/Vagelis1608/piko/commit/b5aa5da0bbf860ec3108bce45b51e401e848d36f))
* **Instagram:** Fix `Remove build expired popup` patch ([1235af4](https://github.com/Vagelis1608/piko/commit/1235af4aac05c939ce5ff84ca570f2dced3e4e24))
* **Instagram:** fix Download media - author and media type ([95c7a73](https://github.com/Vagelis1608/piko/commit/95c7a732479b5954b7793826c37d8e64a4bbc821))
* **Instagram:** fix Download option on feed ([4f4c07f](https://github.com/Vagelis1608/piko/commit/4f4c07fcd64c3bcb513dc59b184d7e3e3cde5bb2))
* **Instagram:** Fix feed download button method fingerprint ([dc1b97e](https://github.com/Vagelis1608/piko/commit/dc1b97ebf1afd5ca03a4de403ec3a9e84144052b))
* **Instagram:** Fix fingerprint of Feed button on click ([9f988e2](https://github.com/Vagelis1608/piko/commit/9f988e269e205609b2122675f88a09862b0d2e2c))
* **Instagram:** Fix fingerprints broken on 423 ([3859ba4](https://github.com/Vagelis1608/piko/commit/3859ba4da669dfb0dbfd23ab66fa3c9354f84199))
* **Instagram:** Fix flag hooks loading ([a673853](https://github.com/Vagelis1608/piko/commit/a673853a8dae600a58dad3144f11310fe4e28475))
* **Instagram:** Fix Friendship status fingerprints broken on 423 ([0f42aaf](https://github.com/Vagelis1608/piko/commit/0f42aaf4e6d818db4a40b83ace1bbe6ca126abf9))
* **Instagram:** Fix friendship status method fingerprint ([276048e](https://github.com/Vagelis1608/piko/commit/276048e0e6ffc31d531096748b1243d1c7500aca))
* **Instagram:** Fix hooks flag (for trigger) ([a3a6c3d](https://github.com/Vagelis1608/piko/commit/a3a6c3d1b9a08f755f12fe46f3b5944e96e708e8))
* **Instagram:** fix padding issue in Piko settings button ([4855f38](https://github.com/Vagelis1608/piko/commit/4855f38410ed6999e3d501cb0301efee4490a148))
* **Instagram:** Fix piko settings action bar ([1712146](https://github.com/Vagelis1608/piko/commit/17121469f71b0c71953f70b2cf6dc09ab920b78a))
* **Instagram:** fix Piko settings issues ([d3369f2](https://github.com/Vagelis1608/piko/commit/d3369f2aa594737bbf73ef86bb8b3001e17c4327))
* **Instagram:** fix piko settings nav bar clipping ([0b94452](https://github.com/Vagelis1608/piko/commit/0b94452310b8d3630142d8b9b3715b4bbea012d9))
* **Instagram:** Fix story button method fingerprint ([ba7b16d](https://github.com/Vagelis1608/piko/commit/ba7b16d599eabb43400f6cb5a8162a8f056c29b6))
* **Instagram:** Fixed sanitize post and reels urls ([61257fb](https://github.com/Vagelis1608/piko/commit/61257fbd601e69b3c507b5da22b687439890c873))
* **Instagram:** Follow indicator handling ([ad3ed3f](https://github.com/Vagelis1608/piko/commit/ad3ed3fd0576c17cf409a69c2703ed0484c0fac0))
* **Instagram:** keep one navigation button visible ([dd5dce8](https://github.com/Vagelis1608/piko/commit/dd5dce8f8974df4e47ff3eb32057ca8ca0cd9c25))
* **Instagram:** Override flags to fix certain issues ([07c6313](https://github.com/Vagelis1608/piko/commit/07c63138482048709618c172bfd8a7a3843d30f2))
* **Instagram:** Potential fix for A16-A17 ([b3352b4](https://github.com/Vagelis1608/piko/commit/b3352b481c0af9c59f587bceb0e1b6f50472437f))
* Missing `,` ([67675fe](https://github.com/Vagelis1608/piko/commit/67675fe381f0554cb69c0f061ec792df9e523479))
* Not creating `values-night-v31` dir ([e3f3491](https://github.com/Vagelis1608/piko/commit/e3f3491fea403f55d5200d1afc4aebd5c7507c2e))
* Opening mod settings with root installation results in crash ([8161644](https://github.com/Vagelis1608/piko/commit/81616443f2104eb1633c2c92c555f45341a7680e))
* Opening mod settings with root installation results in crash ([47e7670](https://github.com/Vagelis1608/piko/commit/47e7670cc09da736cbca6c9447f82d9fa343ee56))
* refactor ([eab113e](https://github.com/Vagelis1608/piko/commit/eab113e471c2b588bbda05acba57e669a312f52c))
* Remove debug prints ([33e4d08](https://github.com/Vagelis1608/piko/commit/33e4d08a58451217781914953c1ffb711ea8480b))
* **Remove Detailed posts:** Change the settings label from "detailed" to "related" ([3cf5f9e](https://github.com/Vagelis1608/piko/commit/3cf5f9ec9e383deb17919f2b3c5254954502c825))
* Remove duplicate strings ([94c6642](https://github.com/Vagelis1608/piko/commit/94c66422e0ced2cbdfd820dfee60cedd2c68e636))
* **Remove Google Ad:** Include ads in the comments ([79d6e35](https://github.com/Vagelis1608/piko/commit/79d6e35144ffc6c81d3bb36499fc2c22e5a089ac))
* Remove obsolete `Open browser chooser on opening links` patch ([a1e2b76](https://github.com/Vagelis1608/piko/commit/a1e2b766a872c3ee2facef1444bfa92ab4236144))
* Remove semicolon ;-) ([46e60f7](https://github.com/Vagelis1608/piko/commit/46e60f71d3eefc2eb81fbca01451d52731c397c1))
* Resource strings getting corrupted, resulting on failure to patch on revanced manager ([#439](https://github.com/Vagelis1608/piko/issues/439)) ([1763137](https://github.com/Vagelis1608/piko/commit/1763137126b9a95df51fe23ce816853ccf0a8f44))
* some patch has compatibleWith and dependsOn in execute block ([dd25a6c](https://github.com/Vagelis1608/piko/commit/dd25a6cd43354b8d6f4cb60d7798c539b06a6e50))
* switch jp to ja for Japanese translation ([c13cc87](https://github.com/Vagelis1608/piko/commit/c13cc87afeaea8cb623e7652a154a507ce532d61))
* **Translations:** Fix unescaped strings in fr and vi ([be94c4c](https://github.com/Vagelis1608/piko/commit/be94c4c3b6785a1f9ecfdc1dbad48a4a9885a539))
* tweet highlight color on hold ([#243](https://github.com/Vagelis1608/piko/issues/243)) ([b22ea42](https://github.com/Vagelis1608/piko/commit/b22ea426830b250abaa336e3b158dea34f82f6d6))
* **Twitter - Bring back twitter:** Add other languages ([2c63ff1](https://github.com/Vagelis1608/piko/commit/2c63ff1bc1444ed6d83f911becca4289001c306c))
* **Twitter - Bring back twitter:** Exclude by default ([e654549](https://github.com/Vagelis1608/piko/commit/e654549c95412b50932453732b215ebb097d4c19))
* **Twitter - Bring back twitter:** Now changes notification icon ([7e281e4](https://github.com/Vagelis1608/piko/commit/7e281e42f2c809ad669113b81f9f888b168882ca))
* **Twitter - Bring back twitter:** Now changes notification icon ([8b57a07](https://github.com/Vagelis1608/piko/commit/8b57a07dfb7ca6ce3d92af92b09f2a786e0544f2))
* **Twitter - Bring back twitter:** Now changes the app name by writing directly to AndroidManifest (Should make patching faster) ([f61468c](https://github.com/Vagelis1608/piko/commit/f61468c4cd1d42d7697a3179a4711dcb9ea01c9e))
* **Twitter - copy media link + Custom download folder:** Update fingerprint to work on latest twitter release ([cc8fadb](https://github.com/Vagelis1608/piko/commit/cc8fadbac2d31139ae8b9572dd1aeb2565564e75))
* **Twitter - Custom Downloader:** Added VideoDataClass Fingerprint ([99ff271](https://github.com/Vagelis1608/piko/commit/99ff271b3fcbf1a6f3666b97c256528435f6501c))
* **Twitter - Custom Downloader:** Improve fingerprints ([f962310](https://github.com/Vagelis1608/piko/commit/f9623106106bd21b9b595983e8db244c8c35e227))
* **Twitter - Custom sharing domain:** Disable by default ([6e7c170](https://github.com/Vagelis1608/piko/commit/6e7c17014b75d098eaef5ba3fbe4ed777eb416b1))
* **Twitter - Dynamic Color:** update border and icon tint colors ([fcd1aa3](https://github.com/Vagelis1608/piko/commit/fcd1aa33fecb0eaaa76b0168d78a56c074874e36))
* **Twitter - Import/Export login token:** Add import menu to piko settings as a workaround for redesigned login screen ([dad823c](https://github.com/Vagelis1608/piko/commit/dad823c3d4a7fa88d5e98cc8b24146fcfb5c5758))
* **Twitter - Log server response:** Escape single qoutes ([cedbfaf](https://github.com/Vagelis1608/piko/commit/cedbfaf77913afb81b0363207a9839ea1624fa63))
* **Twitter - Share Tweet as Image:** Add the patch in the about page ([00fa95e](https://github.com/Vagelis1608/piko/commit/00fa95e307e5a3130d6d216bcdc183312d6a0cc4))
* **Twitter - Share Tweet as Image:** Category title showing up even if patch was disabled ([e03d22e](https://github.com/Vagelis1608/piko/commit/e03d22e6d229b746020d0780e4ffdab0ec5ea0a8))
* **Twitter:** `Customize Navigation Bar items` in/from `10.53.0-beta.1` ([e8154fb](https://github.com/Vagelis1608/piko/commit/e8154fb0ffa91e6d3ed2812bed3f71a034f3bc01))
* **Twitter:** `Disunify xchat system` patch ([ad767b1](https://github.com/Vagelis1608/piko/commit/ad767b10afcc01c83450988816a60cf32d8fc195))
* **Twitter:** `Hide community badges` patch ([f539260](https://github.com/Vagelis1608/piko/commit/f5392600b3e51a3c32fa3ffb4da5d751da3b8612))
* **Twitter:** Add splash screen icon ([b30e083](https://github.com/Vagelis1608/piko/commit/b30e0838de4ac5f72848dcc813d477e52a6d3f1c))
* **Twitter:** Add support for version 10.64.0-beta.1 ([c81378d](https://github.com/Vagelis1608/piko/commit/c81378d80275465acbf9caed5f48235b56395d56))
* **twitter:** Add twitter to compatible package for SelectableTextPatch ([0b6ee33](https://github.com/Vagelis1608/piko/commit/0b6ee33a044433c498c7d522b92b33623dca1a93))
* **Twitter:** Added missing `notifications` item on hide sidebar elements ([39816e9](https://github.com/Vagelis1608/piko/commit/39816e91f85bad367494231e07c8ff1c0d9b58ce))
* **Twitter:** Added warning during `Disunify xchat system` patch failure ([2035e4c](https://github.com/Vagelis1608/piko/commit/2035e4c5f1febcc64959074665c51d28fc7c0cde))
* **Twitter:** Bookmark in nav bar dix ([03fb96c](https://github.com/Vagelis1608/piko/commit/03fb96c485edb8931e9d37452f5a45c0b8a0103b))
* **Twitter:** Bookmark nav bar fix ([a6e8ab9](https://github.com/Vagelis1608/piko/commit/a6e8ab9c6817e15fa7c9ba182650f65ee2e65132))
* **Twitter:** Bring back download and viewcount patch ([3eea91f](https://github.com/Vagelis1608/piko/commit/3eea91f06a65433275bbd7437b290212654a308d))
* **Twitter:** Change patch name from `Enable app icon settings` -> `Enable app icons` ([5a7ef46](https://github.com/Vagelis1608/piko/commit/5a7ef469557e5cf4ecc9ce8465d73c20501dc524))
* **Twitter:** Correct Db clear keyword ([ca71ea7](https://github.com/Vagelis1608/piko/commit/ca71ea73a2957e1c64e1e2ed02b64311287bfaa0))
* **Twitter:** Corrected Moon app icon string ([60d0ede](https://github.com/Vagelis1608/piko/commit/60d0eded80fd32dbc7f1a1c229ed0c86da31efd5))
* **Twitter:** disable `Hide For You` by default. ([b933c19](https://github.com/Vagelis1608/piko/commit/b933c196f8325a02e82520419c049260cc3a4590))
* **Twitter:** Download patch ([f87dee7](https://github.com/Vagelis1608/piko/commit/f87dee798632528595ac3efab1349d7a3fecafa0))
* **twitter:** Exclude `Google Ads Patch` by default ([a26e03a](https://github.com/Vagelis1608/piko/commit/a26e03a157815445d8416a68dd43aa96b2859ce1))
* **Twitter:** fix `Control video auto scroll` in 10.57 ([b7ae78c](https://github.com/Vagelis1608/piko/commit/b7ae78cd61b2f75d266e3fe3d57c5c21cd798e79))
* **Twitter:** Fix `Custom download folder` in/from 11.51.xx ([c885395](https://github.com/Vagelis1608/piko/commit/c885395fce086f1f6791722cc615b671a6c69027))
* **Twitter:** fix `Custom downloader` patch ([f4d953a](https://github.com/Vagelis1608/piko/commit/f4d953a3dc7cb8325e56e515cd38a8ab707d2162))
* **Twitter:** Fix `Custom sharing domain` not overriding new share sheet ([fd446fa](https://github.com/Vagelis1608/piko/commit/fd446fad33d7ceaf98666cbefde1f03e2315c55f))
* **Twitter:** fix `Custom translator` patch ([8065fa3](https://github.com/Vagelis1608/piko/commit/8065fa32019d1d1bd4c9bd116f1774e345203356))
* **Twitter:** Fix `Customize notification tabs` patch in 11.81 ([fa81d84](https://github.com/Vagelis1608/piko/commit/fa81d844096ce7a941df12a6301ff48c2f489582))
* **Twitter:** Fix `Customize notification tabs` patch on 11.78.xx ([8f884e5](https://github.com/Vagelis1608/piko/commit/8f884e56e3b95581c96bc67e7801369b42f7d5f0))
* **Twitter:** Fix `Customize notification tabs` patch on 11.78.xx ([05958d2](https://github.com/Vagelis1608/piko/commit/05958d2de69935b2a9de1550f06eeed4e2debaee))
* **Twitter:** Fix `Customize profile tabs` crash after `10.43` ([a38d621](https://github.com/Vagelis1608/piko/commit/a38d6213e06404fde21f6b5b8eddfcdfe8edd73e))
* **Twitter:** Fix `Customize side bar items` patch ([4664f02](https://github.com/Vagelis1608/piko/commit/4664f02c065396dc28406fe5b47478eff6b6c4aa))
* **Twitter:** Fix `Customize timeline top bar` fingerprint (again) ([189dfdd](https://github.com/Vagelis1608/piko/commit/189dfdd9e02de3869ed331d0258f4e83da309299))
* **Twitter:** Fix `Customize timeline top bar` logic ([642d092](https://github.com/Vagelis1608/piko/commit/642d0927a4819743a40d662db5c70cc3a4ff76d2))
* **Twitter:** Fix `Customize timeline top bar` patch ([2aa2a36](https://github.com/Vagelis1608/piko/commit/2aa2a3644956f588c46e9b3f08a94a2def9908d7))
* **Twitter:** Fix `Customize timeline top bar` patch - update tab ids ([c1d66c4](https://github.com/Vagelis1608/piko/commit/c1d66c42a56854f67633a07fb50d866c70ae096c))
* **Twitter:** fix `Enable app icon settings` patch ([c2b6f79](https://github.com/Vagelis1608/piko/commit/c2b6f79b5c833c2441432b2511374361318e5507))
* **Twitter:** fix `Enable debug menu for posts` patch ([72a72f2](https://github.com/Vagelis1608/piko/commit/72a72f2114d0ee9fe2cac0e5eae5b03e196dd6e2))
* **Twitter:** fix `Enable force HD videos` patch ([23f2859](https://github.com/Vagelis1608/piko/commit/23f285974c8c12a117b81c794a64e94e6f33e531))
* **Twitter:** fix `Enable force HD videos` patch ([6d8d200](https://github.com/Vagelis1608/piko/commit/6d8d200a521375252c675117365e1fb85f701083))
* **Twitter:** Fix `Enable Undo Posts` patch ([883b6cb](https://github.com/Vagelis1608/piko/commit/883b6cb92c52d1a475f6663bdf474518280b4da4))
* **Twitter:** Fix `Extension hook` ([6fb52f7](https://github.com/Vagelis1608/piko/commit/6fb52f7307b596988ee8b4286717b378d3c2ca4d))
* **Twitter:** Fix `Hide nudge button` patch ([87ceb49](https://github.com/Vagelis1608/piko/commit/87ceb49f841c99012fcbbc315edc1c4657376e37))
* **Twitter:** Fix `Hide nudge button` patch ([d7572fe](https://github.com/Vagelis1608/piko/commit/d7572feac66d44f0fe669073ee09bc09637adb9a))
* **Twitter:** fix `Hide nudge button` patch (again) ([be2cd9d](https://github.com/Vagelis1608/piko/commit/be2cd9de0aa2545274369ed0c724ffead77148ee))
* **Twitter:** Fix `Hide Promoted Trends` patch ([7052d25](https://github.com/Vagelis1608/piko/commit/7052d2583527354ee1a719f808993049364c8718))
* **Twitter:** Fix `Log server response` patch on 11.77.xx ([08f7fb0](https://github.com/Vagelis1608/piko/commit/08f7fb0aed0ca20f1d44fe46d8e1469d0fa787d4))
* **Twitter:** Fix `Log server response` patch on 11.77.xx ([c2111f1](https://github.com/Vagelis1608/piko/commit/c2111f1fd166107eefc436c38f320bd1db33a905))
* **Twitter:** Fix `Native reader mode` deeplink ([24be415](https://github.com/Vagelis1608/piko/commit/24be4154d5a17a2c065dc8cff66b4087a165090a))
* **Twitter:** Fix `Native reader mode` patch in 10.28 and above ([800da14](https://github.com/Vagelis1608/piko/commit/800da149f4179044296d265ff4de9e7b2737e9b8))
* **Twitter:** fix `Reader mode` for 10.34 ([01cb8c9](https://github.com/Vagelis1608/piko/commit/01cb8c94c951c103f0ebea56f8daf88214eb77ae))
* **Twitter:** Fix `Remove premium upsell` patch ([4df5e32](https://github.com/Vagelis1608/piko/commit/4df5e32088eb57702c5f30e20b3c75d2ec11ee87))
* **Twitter:** fix `Remove videos for you` patch ([b19f943](https://github.com/Vagelis1608/piko/commit/b19f943ee8a19ea158e89cc031ae037e43da6e50))
* **Twitter:** Fix `Show post source label` patch ([42efbe2](https://github.com/Vagelis1608/piko/commit/42efbe23f17b44259fbc597f1ec72b0456bece15))
* **Twitter:** Fix aapt breakage due to tag mismatch ([730a51c](https://github.com/Vagelis1608/piko/commit/730a51c20f464bbe2b680004721161dd5f34dadf))
* **Twitter:** Fix App icon error toast ([2997b56](https://github.com/Vagelis1608/piko/commit/2997b56f13c37681acbf89efcbd12647ee1c5056))
* **Twitter:** Fix font import bug. ([c8ea53c](https://github.com/Vagelis1608/piko/commit/c8ea53c8a50d3854911aec5dd2205661eba54ed5))
* **Twitter:** Fix font section header ([35e9b2b](https://github.com/Vagelis1608/piko/commit/35e9b2beb9efdb8d624455714c99cebbffed574e))
* **Twitter:** Fix font section header ([a7a7b2e](https://github.com/Vagelis1608/piko/commit/a7a7b2e719293102b45e202505eeb032f81d06c0))
* **Twitter:** Fix GIFs downloading as image via native downloader ([5b40c87](https://github.com/Vagelis1608/piko/commit/5b40c87bc3cc383f127e20243a1482c3e7613e3b))
* **Twitter:** Fix GIFs downloading as image via native downloader ([d18317a](https://github.com/Vagelis1608/piko/commit/d18317a4f7b7e013765143f33d34807e3764a063))
* **Twitter:** fix high resolution video extraction ([3ecf524](https://github.com/Vagelis1608/piko/commit/3ecf52427de28e7ec1e876a81201e07a73081d39))
* **Twitter:** Fix image link on post text ([5745621](https://github.com/Vagelis1608/piko/commit/57456212d2135fab771a158ebb18bcc26d8256fe))
* **Twitter:** Fix remove ads on replies ([8fda05e](https://github.com/Vagelis1608/piko/commit/8fda05ec94ffc7a48dfc1eb3a17bb14f6328ca6f))
* **Twitter:** Fix Settings crash ([015c5bd](https://github.com/Vagelis1608/piko/commit/015c5bdd1247ec6263fa194ca6e580690e13e223))
* **Twitter:** Fix share menu patches ([ba561be](https://github.com/Vagelis1608/piko/commit/ba561be67cf5d854cfff477a3a80b85928a4170a))
* **Twitter:** Fix tweet short text extraction for `Custom translator` patch ([18becfb](https://github.com/Vagelis1608/piko/commit/18becfb31e68e05d571bd8651ba7ebfe7ecba3d1))
* **Twitter:** Fix unescaped characters ([829eedd](https://github.com/Vagelis1608/piko/commit/829eedd90eabc13575b49da9cc5551f894787b76))
* **Twitter:** Fix unescaped strings ([41405a7](https://github.com/Vagelis1608/piko/commit/41405a75e50141e902aaac74f5fad9a2fcb06422))
* **Twitter:** fix video entity hook in `10.58` ([e8a833d](https://github.com/Vagelis1608/piko/commit/e8a833d2123b92a40caf68b4f6798e822a6d1737))
* **Twitter:** Fixed host name issue due to `Custom sharing domain` patch ([3b26c84](https://github.com/Vagelis1608/piko/commit/3b26c84a902200f687cd327fb83281301e653dc1))
* **Twitter:** Fixed preference import ([4623b93](https://github.com/Vagelis1608/piko/commit/4623b93b68b18f42d0b8c435d4089f903ddfe4fd))
* **Twitter:** Fixup patch dependecy ([867926a](https://github.com/Vagelis1608/piko/commit/867926acccd1b768b63475aa79d376940a87e075))
* **Twitter:** high resolution video entity fingerprint ([2025afb](https://github.com/Vagelis1608/piko/commit/2025afb553fe5c7b72410286aecfaafc4b009d6b))
* **Twitter:** Missing download option in immersive view ([6b0aa2c](https://github.com/Vagelis1608/piko/commit/6b0aa2c0d8d0f9192630e42abef418a834a95df0))
* **Twitter:** Only show settings category if patch is applied ([2141680](https://github.com/Vagelis1608/piko/commit/21416800ce7176c713b1521649d9760fcd450158))
* **twitter:** Refactor packages ([8a5cea6](https://github.com/Vagelis1608/piko/commit/8a5cea659350a774fe97ec52bc467f10ba1be341))
* **twitter:** Remove debug code ([2eb2fa3](https://github.com/Vagelis1608/piko/commit/2eb2fa34e101a6d838b28eabc3c0c7ae08af9dc4))
* **Twitter:** revert `semantic-release` version ([b50c530](https://github.com/Vagelis1608/piko/commit/b50c5301139ea1b972b6ccd507c929896219ff26))
* **Twitter:** Share menu button add hook in/from 10.67 ([a640946](https://github.com/Vagelis1608/piko/commit/a640946e7045be359535ed0eead00ec80d2e10c4))
* **Twitter:** Update `extensions` hook ([bf20765](https://github.com/Vagelis1608/piko/commit/bf2076592f49c11337acedf0d90e8a9d2d8d4ba4))
* **ui:** adjust monet-light colors to have a white background ([0906e93](https://github.com/Vagelis1608/piko/commit/0906e93027747e43becd1d94bca24f54ecc97683))
* Unescaped apostrophe ([487e992](https://github.com/Vagelis1608/piko/commit/487e99259b772cbf44f09028807db223f464df85))
* unescaped character on `pl` string values ([a6444be](https://github.com/Vagelis1608/piko/commit/a6444bed45872df6a55be17a2b64dd2d40e2d16a))
* Unescaped characters ([8e539df](https://github.com/Vagelis1608/piko/commit/8e539dfd8c4e1ef6889357b9850a842db54a2a99))
* **Universal:** Set version code as int ([ee83df7](https://github.com/Vagelis1608/piko/commit/ee83df7f8f18cf4cf2306b0a662a845ed565e106))
* unshort url for 10.30 ([ef3e00f](https://github.com/Vagelis1608/piko/commit/ef3e00f80fc469e5f09f8d7e43136791dbd94872))
* update pr if it already exists ([6d616d2](https://github.com/Vagelis1608/piko/commit/6d616d20ea0a0a4880e5fb339dd569db1cc530a2))
* Update pull_request.yml[skip ci] ([30e1e4f](https://github.com/Vagelis1608/piko/commit/30e1e4f828e4018b3595ea99d21d2a527145b2f5))
* URL decode path to JAR containing spaces by osumatrix ([e6671ba](https://github.com/Vagelis1608/piko/commit/e6671ba4a8359db7aefa1ab20600e1f17144e002))
* Use the original poster's username/name for retweet posts. ([1a1f818](https://github.com/Vagelis1608/piko/commit/1a1f818779d9c4359ca0574ff2bef1e6db525582))
* Use UrlDecoder API available in older Android versions ([d9e6374](https://github.com/Vagelis1608/piko/commit/d9e63740b7eb7c8a4f44abf6d59998ea14194346))
* webview resource id ([fd544a9](https://github.com/Vagelis1608/piko/commit/fd544a9a0796f4f9fffb8c9b876069cfb1e43bc8))
* wrong index number on multiple medias ([d088d03](https://github.com/Vagelis1608/piko/commit/d088d03a5dc743e1e50f403d14b71bc59b38571b))

### ✨ New Features

* Add `Browse tweet object` patch ([2e05c33](https://github.com/Vagelis1608/piko/commit/2e05c334ee32ba6075249bb873f13ba6d822d77e))
* Add `Import/Export login token` patch ([5667e4c](https://github.com/Vagelis1608/piko/commit/5667e4cd251685a01d9459a2c637a79a832259b6))
* Add `Show poll results` patch ([7b48f1b](https://github.com/Vagelis1608/piko/commit/7b48f1b9da05deb9aae73f0982f65eb527666fdc))
* Add russian translation ([2dc9cee](https://github.com/Vagelis1608/piko/commit/2dc9ceed63a5a965f9979e3df1094f6b7a12a001))
* Add settings for `Disable chirp font` patch ([dad0a70](https://github.com/Vagelis1608/piko/commit/dad0a70b13a281937ea608e7866b20ae30863cb9))
* Add support for adding custom feature flags ([a6a91d1](https://github.com/Vagelis1608/piko/commit/a6a91d13a8623b505ba299ee23845f2a62399f33))
* Add support for patches.json ([f5f63a3](https://github.com/Vagelis1608/piko/commit/f5f63a330a06d03a10e1a3232d96764fc2d1ac7c))
* Add toggle for `Open browser chooser on opening links` patch ([6f217f0](https://github.com/Vagelis1608/piko/commit/6f217f08a8037be067791b318b750d7f6d91b4ea))
* Added resource file for strings ([181fd29](https://github.com/Vagelis1608/piko/commit/181fd298748c38dc53c10609b6714d8ce255d5be))
* **all:** Added `Export all activities` patch from ReVanced ([7cc405f](https://github.com/Vagelis1608/piko/commit/7cc405f7e900b85aaa172e8693cd4ca2e790451d))
* **Bring back twitter:** Add Japanese ([4eb08b5](https://github.com/Vagelis1608/piko/commit/4eb08b554eaf92958e0e159647fc71b35340e2b2))
* **Bring back twitter:** Use strings from Twitter 9.98.0 for all languages ([68cf8c3](https://github.com/Vagelis1608/piko/commit/68cf8c379292ddfb80e3d11b7851703ffb7eca8b))
* **Bring back twitter:** Use strings from Twitter 9.98.0 for all languages ([ebcfb9a](https://github.com/Vagelis1608/piko/commit/ebcfb9ae7bdbb8f3648b4191ee7c448ee4f6c90a))
* Change to Morphe patcher 1.1.1 ([31eb19e](https://github.com/Vagelis1608/piko/commit/31eb19e05f5dae9c4531db3c33dd8bc966b7b515))
* **Change version code:** Add compatibleWith to make it a non-universal patch ([c684cbc](https://github.com/Vagelis1608/piko/commit/c684cbc04017549ef247438764d6f10828912c7b))
* **Change version code:** Add compatibleWith to make it a non-universal patch ([3664dbf](https://github.com/Vagelis1608/piko/commit/3664dbf560b9dc61cc90de4e6f53f54d86f528b0))
* **ci:** Add updates and refactors to changelog ([5fb8ef7](https://github.com/Vagelis1608/piko/commit/5fb8ef7902e6be592305c34cf3add0f06e477a68))
* **Customize side bar items:** Allow for hiding of the "Jobs" item ([14ce811](https://github.com/Vagelis1608/piko/commit/14ce811a7b4d885fa6779524aad0b41034a2d8d0))
* Enable recent patches by default ([e84f358](https://github.com/Vagelis1608/piko/commit/e84f358e494830fdecdc3dd12662b5f5ccd644b3))
* **Hook feature flag:** Added ability to search for supported flags. ([28a2c0a](https://github.com/Vagelis1608/piko/commit/28a2c0a6ca97fa50711ce44cfa1f20b5147e906f))
* **Instagram - Translations:** Added `Japanese` Translation ([#1143](https://github.com/Vagelis1608/piko/issues/1143)) ([07e62c1](https://github.com/Vagelis1608/piko/commit/07e62c1636724a4afa70aad27df17a8fb67ae42c))
* **Instagram - Translations:** Added `Portuguese` Translation ([#1145](https://github.com/Vagelis1608/piko/issues/1145)) ([8d36aaf](https://github.com/Vagelis1608/piko/commit/8d36aaf263eb8339f12a403fd3ac2889bfce7d0b))
* **Instagram:** Add `Disable Reels scrolling` patch ([9a03ca1](https://github.com/Vagelis1608/piko/commit/9a03ca1ed1ec529489dcca73cb8b7fb314ea198b))
* **Instagram:** Add `Hide navigation buttons` patch ([948f136](https://github.com/Vagelis1608/piko/commit/948f1362b298668c8ec960f2801bb1b2c7807a04))
* **Instagram:** Add `Hide reshare button` patch ([84ad6ae](https://github.com/Vagelis1608/piko/commit/84ad6ae7b4f3112a2175b1360c113c9a71b1ff9b))
* **instagram:** add amoled theme patch ([f34ea47](https://github.com/Vagelis1608/piko/commit/f34ea473d3a63b6afd35f573bb88d7aad1178813)), closes [#ff000000](https://github.com/Vagelis1608/piko/issues/ff000000) [#ff0c1014](https://github.com/Vagelis1608/piko/issues/ff0c1014) [#000000](https://github.com/Vagelis1608/piko/issues/000000)
* **Instagram:** Added `Change like animation` patch ([cb759bc](https://github.com/Vagelis1608/piko/commit/cb759bcab2e754a794a907846e077a956416e363))
* **Instagram:** Added `Copy comment` patch ([eb3f378](https://github.com/Vagelis1608/piko/commit/eb3f378a2e29ad60560cb6ccc0f05ab9eca44aae))
* **Instagram:** Added `Customise story ring size` patch ([cfe8a55](https://github.com/Vagelis1608/piko/commit/cfe8a55423e2e1f53dbc769beb082644d1bc3689))
* **Instagram:** Added `Customise story timestamp` patch ([421ca76](https://github.com/Vagelis1608/piko/commit/421ca76dfa2f67b77bafed5c477c1e24f50657a4))
* **Instagram:** Added `Disable ads` patch ([4046078](https://github.com/Vagelis1608/piko/commit/40460788ac473f32f2dbee9735b691e0086d3b31))
* **Instagram:** Added `Disable analytics` patch ([e01da66](https://github.com/Vagelis1608/piko/commit/e01da663b520a00b386016cfc00d733a3b39ec70))
* **Instagram:** Added `Disable discover people` patch ([36fbfb5](https://github.com/Vagelis1608/piko/commit/36fbfb53f48996c977507c675c8ca4cc426f387b))
* **Instagram:** Added `Disable double tap like` patch ([daa8474](https://github.com/Vagelis1608/piko/commit/daa84741cb05f1d7bd4af63dfe3458125a7df5c5))
* **Instagram:** Added `Disable highlights` patch ([03f367e](https://github.com/Vagelis1608/piko/commit/03f367eb1a371b46e1425028a861d44886ecd906))
* **Instagram:** Added `Disable screenshot detection` patch ([a1141c9](https://github.com/Vagelis1608/piko/commit/a1141c9af37bfac52a06c2ea86a1b9c72b2de8b0))
* **Instagram:** Added `Disable story flipping` patch ([05f374b](https://github.com/Vagelis1608/piko/commit/05f374b4fbe54e8bd8cc165545c6d7e7d01848a7))
* **Instagram:** Added `Disable video autoplay` patch ([9294e08](https://github.com/Vagelis1608/piko/commit/9294e08699c8e996140a8cd84f345819eee96dab))
* **Instagram:** Added `Distraction free` patches ([ec3ae44](https://github.com/Vagelis1608/piko/commit/ec3ae44a0fbfe95515e5250d7e366fcbf88eb8a3))
* **Instagram:** Added `Download media` patch ([b87f023](https://github.com/Vagelis1608/piko/commit/b87f02368f26185cf6881d68d63f91830ff46fe8))
* **Instagram:** Added `Enable whitehat settings` patch ([31529bb](https://github.com/Vagelis1608/piko/commit/31529bb0a2c90a700dc99b54f9302377ca29f91e))
* **Instagram:** Added `Follow back indicator` patch ([e6974a1](https://github.com/Vagelis1608/piko/commit/e6974a14f23cc549ff1330e3fce125ddee930e15))
* **Instagram:** Added `Hide group creation button on sharesheet` patch ([8faab8c](https://github.com/Vagelis1608/piko/commit/8faab8cd984e2dede46aa9ed0355b7c63e2d0535))
* **Instagram:** Added `Hide notes tray` patch ([a856398](https://github.com/Vagelis1608/piko/commit/a8563984fe465ae8cc8e7e1a0d3b129ae343ca81))
* **Instagram:** Added `Hide stories tray` patch ([c4af4df](https://github.com/Vagelis1608/piko/commit/c4af4df649762d0b4f1409849edd7fa6626ca3c7))
* **Instagram:** Added `Hide suggested content` patch ([2a10346](https://github.com/Vagelis1608/piko/commit/2a10346a3ff680e0ebda33fb2cff547de46457fe))
* **Instagram:** Added `Improve image viewing` patch ([d716354](https://github.com/Vagelis1608/piko/commit/d7163541f0678bf532d137e2147572975d925638))
* **Instagram:** Added `Improve image viewing` patch ([72d103d](https://github.com/Vagelis1608/piko/commit/72d103da8c059e2751fdb54c968995a669b1612f))
* **Instagram:** Added `More options on post` patch ([19db767](https://github.com/Vagelis1608/piko/commit/19db767dbeb00d9d5cd46552ba2bd425753eef2e))
* **Instagram:** Added `More options on profile` patch ([1cd5797](https://github.com/Vagelis1608/piko/commit/1cd5797d945b7ecbdaa295b1a426302784546975))
* **Instagram:** Added `Open links externally` patch ([d199468](https://github.com/Vagelis1608/piko/commit/d1994683fac5e9734e4287c424f25205e21de80f))
* **Instagram:** Added `Remove build expired popup` patch ([8932242](https://github.com/Vagelis1608/piko/commit/89322421eb2d1f0fbd0e6c2b937e23cd987005ec))
* **Instagram:** Added `Remove empty bottom space` patch ([2b0eb1f](https://github.com/Vagelis1608/piko/commit/2b0eb1fa94cfc8c5d6b7d713a8080c351fa25d66))
* **Instagram:** Added `Sanitize share links` patch ([43a886f](https://github.com/Vagelis1608/piko/commit/43a886ffa801476d57a14a40fd149fc09ec7aa9a))
* **Instagram:** Added `Stories audio autoplay` patch ([f514dcf](https://github.com/Vagelis1608/piko/commit/f514dcf35bd77fe318103741c95adf5f7ccfcff6))
* **Instagram:** Added `Unlimited replays on ephemeral media` patch ([00e3656](https://github.com/Vagelis1608/piko/commit/00e3656db467efd5fbca9de9884716fe75faa188))
* **Instagram:** Added `Unlock employee options` patch ([6041c06](https://github.com/Vagelis1608/piko/commit/6041c06875ba7e879f2fbd07a49f8596af1368bb))
* **Instagram:** Added `Unlock Plus benefits` patch ([84d9fd6](https://github.com/Vagelis1608/piko/commit/84d9fd62e12d103a833e386c90504b97a4652744))
* **Instagram:** Added `View live anonymously` patch ([d5c6fb3](https://github.com/Vagelis1608/piko/commit/d5c6fb3dc87288eb3429a898d132b55c98609091))
* **Instagram:** Added `View stories anonymously` patch ([2fab876](https://github.com/Vagelis1608/piko/commit/2fab8765622b41e7e11cfb57493bd09b788eee27))
* **Instagram:** Added `View story mentions` patch ([ebddfbe](https://github.com/Vagelis1608/piko/commit/ebddfbeb46ec781ddcabc7956ca9a40645f5cb18))
* **Instagram:** Added ability to download audio from some posts and reel ([8d503d3](https://github.com/Vagelis1608/piko/commit/8d503d3ecffd66949779acb5cc24480e75f06f91))
* **Instagram:** Added ability to download mappings ([ee843af](https://github.com/Vagelis1608/piko/commit/ee843af511c656e3a6ce4fa86102459ff80392e0))
* **Instagram:** Added debug option to extraction developer options codes ([313e15c](https://github.com/Vagelis1608/piko/commit/313e15c74be4f0c389ecebce8447fcdfc455c95e))
* **Instagram:** Added delete analytics cache folder ([f1a1602](https://github.com/Vagelis1608/piko/commit/f1a16029c2d0951a77dbad5dff0735abc3fb4d47))
* **Instagram:** Added hook to override developer flags ([01e43a6](https://github.com/Vagelis1608/piko/commit/01e43a6f206af4692f3545adf8680f77f855dddc))
* **Instagram:** Added mapping restore ([6691e56](https://github.com/Vagelis1608/piko/commit/6691e565722877aca516a8b6bf531fab667574af))
* **Instagram:** Added one time welcome message on launch ([6d03daa](https://github.com/Vagelis1608/piko/commit/6d03daa1dba71482d373f726f67d359e8958dfcb))
* **Instagram:** Added open media externally ([9d0b1eb](https://github.com/Vagelis1608/piko/commit/9d0b1ebd6d71eb3db43123f9b8577f29c75fb223))
* **Instagram:** Added override backup ([9b9498a](https://github.com/Vagelis1608/piko/commit/9b9498abf51c75b24578470d473076eb35421990))
* **Instagram:** Added override restore ([7d433b2](https://github.com/Vagelis1608/piko/commit/7d433b2c39a2e8eb9c70324582d9704a7c7889b5))
* **Instagram:** Added patch information in settings ([90f1885](https://github.com/Vagelis1608/piko/commit/90f1885dc65d0a1670d751fe25367ffd711f992e))
* **Instagram:** Added settings and developer options patch ([859c684](https://github.com/Vagelis1608/piko/commit/859c6847ee2e45f33812c66201e3fd9f8a96689c))
* **Instagram:** Added support to `425.0.0.47.61` ([f02ede0](https://github.com/Vagelis1608/piko/commit/f02ede0ee1f8444dfae5580c4dcee63d49bb3d5e))
* **Instagram:** Added support to `426.0.0.37.68` ([dce5983](https://github.com/Vagelis1608/piko/commit/dce598300cb6af1cad291e4b820bd7ce6e441b9a))
* **Instagram:** handle signature check on link share and on incoming link ([7698274](https://github.com/Vagelis1608/piko/commit/76982744b7adcc8cac5470586af9d27bad9a01c6))
* **Instagram:** Initial support for translations ([caf8ffb](https://github.com/Vagelis1608/piko/commit/caf8ffb7704ae514a3b5f98ae265878214d42ae5))
* Migrate ci ([c737ca8](https://github.com/Vagelis1608/piko/commit/c737ca8edef074ff1beff17db7d27e5f26c17dc1))
* no t.co links ([776e700](https://github.com/Vagelis1608/piko/commit/776e7007b571cc2803d566891c72a42057297bb6))
* Quick settings button is now optional ([e9e54e5](https://github.com/Vagelis1608/piko/commit/e9e54e5e44437b92db9700c363f0abd9117cc325))
* Read DMs anonymously ([48f1593](https://github.com/Vagelis1608/piko/commit/48f1593e303f00cb4fb1e14233ac51d03f273ae3))
* Remove throw file ([86bff99](https://github.com/Vagelis1608/piko/commit/86bff993636928c67ca95dabeebcf1f5cc191a36))
* **Settings:** Add a description to "Native features" page ([be7aa54](https://github.com/Vagelis1608/piko/commit/be7aa5472c9b12ff6207992b21292b4fb4d337cf))
* **Settings:** Allow preference titles to be multiple lines ([5581330](https://github.com/Vagelis1608/piko/commit/558133068396d532837c53347288fa42a7fb47f6))
* **Settings:** Allow preference titles to be multiple lines ([3075555](https://github.com/Vagelis1608/piko/commit/3075555611163ff67c073afd887d7fff4aeb45a7))
* **Show poll results:** Add a toggle on mod settings ([2624561](https://github.com/Vagelis1608/piko/commit/262456164e84d81b6c33436ac9f8fa21fa05e2ba))
* **Translations-Instagram:** Added `Indonesian` translations ([4a77dcb](https://github.com/Vagelis1608/piko/commit/4a77dcb64b3747b04535999b0809908f93cc39d6))
* **Translations-Instagram:** Added `Polish` translation ([#1089](https://github.com/Vagelis1608/piko/issues/1089)) ([99ccf20](https://github.com/Vagelis1608/piko/commit/99ccf20e3f88d39be9c4ea1b2d248479bfe790ba))
* **Translations-Instagram:** Added `Russian` translations ([b8b951b](https://github.com/Vagelis1608/piko/commit/b8b951b14267aaafb8193c65553dd6ea3cdbce3f))
* **Translations-Instagram:** Added `Turkish` translations ([#1103](https://github.com/Vagelis1608/piko/issues/1103)) ([6f03170](https://github.com/Vagelis1608/piko/commit/6f03170d88b4f9fc2c156838cbafc792246496fa))
* **Translations:** Add `Turkish` ([bf70b91](https://github.com/Vagelis1608/piko/commit/bf70b913775ec299a87725b15d30bb2506da7a5d))
* **Translations:** Add Arabic translations ([c1d797b](https://github.com/Vagelis1608/piko/commit/c1d797b21bcbf0752bb48c94e4009e8221e46b36))
* **Translations:** Add Brazilian Portuguese translations [Bring back Twitter] ([3a831d3](https://github.com/Vagelis1608/piko/commit/3a831d3869a5fbbb22342cbfe1859241b2126fa5))
* **Translations:** add hindi ( हिन्दी ) translations [#91](https://github.com/Vagelis1608/piko/issues/91) ([a766771](https://github.com/Vagelis1608/piko/commit/a766771d848a43c3a4d2ba5e955ab72015dfb69d))
* **Translations:** Add italian translation ([88e22fb](https://github.com/Vagelis1608/piko/commit/88e22fbb64eae5b2b185c0c785d75a29bb342458))
* **Translations:** Add japanese ([c123d8e](https://github.com/Vagelis1608/piko/commit/c123d8ed58f92dce6337cd194be64e21b3d9559c))
* **Translations:** Add polish translation ([8102f35](https://github.com/Vagelis1608/piko/commit/8102f35bab392acd8337fdf363c8891e3b96f629))
* **Translations:** Add simplified Chinese translation ([7662a34](https://github.com/Vagelis1608/piko/commit/7662a34a87e2dd5d819188993054a8fc4808ef03))
* **Translations:** Add Simplified Chinese translations and Taiwanese Traditional Chinese translations[Bring back Twitter] ([d44bfd7](https://github.com/Vagelis1608/piko/commit/d44bfd73f0063703179c097d68738063a000d80b))
* **Translations:** Added Brazilian Portuguese [#90](https://github.com/Vagelis1608/piko/issues/90) ([ad307da](https://github.com/Vagelis1608/piko/commit/ad307da5ba7f0739024c7a30de2cb3b09d8aee28))
* **Translations:** Added Traditional Chinese translation ([1c0b10a](https://github.com/Vagelis1608/piko/commit/1c0b10af732a6e159862a99369b57368cbbdab91))
* **Translations:** Fix Simplified Chinese Translation ([ec0a3dc](https://github.com/Vagelis1608/piko/commit/ec0a3dcadf4027c3a6a6d411d44043d245b5ca29))
* **Translations:** French translation added ([a6f650c](https://github.com/Vagelis1608/piko/commit/a6f650c3cbea3b3964fc4b58962067e16609a848))
* **Translations:** Korean translation added ([492e631](https://github.com/Vagelis1608/piko/commit/492e6312df05d3bdae618e350a929a8b22914c98))
* **Translations:** Update `japanese` ([444623f](https://github.com/Vagelis1608/piko/commit/444623faaa5761b33445705e04e5c3078ff88124))
* **Translations:** Update `japanese` ([f5ece19](https://github.com/Vagelis1608/piko/commit/f5ece191a724f7bc0aed0cb90df8902f6d9e110b))
* **Translations:** Update `Japanese` ([80282f0](https://github.com/Vagelis1608/piko/commit/80282f0e4eb3b6f1cde7eb6e30f7d00ba9b26a0c))
* **Translations:** Update `Japanese` ([a7da7d7](https://github.com/Vagelis1608/piko/commit/a7da7d7468203a3244496b4ed692a8d09da18b45))
* **Translations:** Update `Japanese` ([039aac3](https://github.com/Vagelis1608/piko/commit/039aac304215858769c794684f837719edad9790))
* **Translations:** Update `Polish` ([97b3790](https://github.com/Vagelis1608/piko/commit/97b379029deba1044436cb5a983335b515e7f959))
* **Translations:** Update `Polish` ([e49393e](https://github.com/Vagelis1608/piko/commit/e49393eefe75118c29575324f5832c7cc3589530))
* **Translations:** Update `Polish` ([d81f93c](https://github.com/Vagelis1608/piko/commit/d81f93cff2c31c9fe82ff8e43598ab90e6d899ab))
* **Translations:** Update Russian translation ([54ba664](https://github.com/Vagelis1608/piko/commit/54ba664921218ce79218e4ce4a9a2d4d2d1cf1b6))
* **Translations:** Update Russian translation ([3606c10](https://github.com/Vagelis1608/piko/commit/3606c101ae1630c303a8ed55c4e21ab75346fbbe))
* **Translations:** Updated Brazilian Portuguese ([e25ec0e](https://github.com/Vagelis1608/piko/commit/e25ec0ecee9e576f6fe74c2bf70d750399275b7e))
* **Translations:** Updated Brazilian Portuguese ([45aac73](https://github.com/Vagelis1608/piko/commit/45aac7374731e2d3b4a24e3c22ad5aaaccbbc33a))
* **Translations:** Updated Traditional Chinese string-zh-rCN.xml ([6cc2373](https://github.com/Vagelis1608/piko/commit/6cc2373e417a1ed386a2682f970662e367033b43))
* **Translations:** Updated Traditional Chinese string-zh-rTW.xml ([6787c28](https://github.com/Vagelis1608/piko/commit/6787c28318762382d73f1eb8c6ad9abc4b2ee2e6))
* **translation:** Update Simplified Chinese translation ([4f3027a](https://github.com/Vagelis1608/piko/commit/4f3027a2279e9cd1a2cc010d190cab3551c45cd4))
* **Translation:** Update Simplified Chinese translation ([b9fe0e8](https://github.com/Vagelis1608/piko/commit/b9fe0e83a3ddd1fd2633dca6403723c4dbea32ce))
* **Twitter:** Add `Bring back twitter` patch ([b299b0c](https://github.com/Vagelis1608/piko/commit/b299b0c076a9ef68970bc57547830027d336b442))
* **twitter:** Add `Clear tracking params` patch @FrozenAlex's ([c1f3148](https://github.com/Vagelis1608/piko/commit/c1f3148c8b701d76fa518256b320552b9b8a2dd7))
* **Twitter:** Add `Custom download folder` ([7c93541](https://github.com/Vagelis1608/piko/commit/7c935415329303066cd69753bdeba9657be0f742))
* **Twitter:** Add `Custom sharing domain` patch ([8ffd36c](https://github.com/Vagelis1608/piko/commit/8ffd36c4097f3dc1de9f654b44f077e8ed1e9481))
* **Twitter:** Add `Disable chirp font` patch ([59eafd1](https://github.com/Vagelis1608/piko/commit/59eafd1ecf9459123fd8565121fd0a42404956bc))
* **Twitter:** Add `Dynamic color` patch from revanced ([d2bd0ef](https://github.com/Vagelis1608/piko/commit/d2bd0ef4a6c36650edde7c6d8c0c7587dcfb46ac))
* **Twitter:** Add `Premium settings` patch, Unlocks premium options from settings like custom app icon and custom navbar ([066e953](https://github.com/Vagelis1608/piko/commit/066e9538a983e6c261a56b1b568375132c0ca33c))
* **Twitter:** Add `Share Tweet as Image` ([e8d6321](https://github.com/Vagelis1608/piko/commit/e8d6321cbb9d22d91702dfab583255dca0b7d99c))
* **Twitter:** Add back settings ([5ba3580](https://github.com/Vagelis1608/piko/commit/5ba3580ec94a158c2e1043393aab76a0fae3481c))
* **Twitter:** Add download media button in tweet inline action items ([#806](https://github.com/Vagelis1608/piko/issues/806)) ([d79c6e8](https://github.com/Vagelis1608/piko/commit/d79c6e8efe89e46482d7143f50f4eacda07628ca))
* **twitter:** Add download patch ([b9612bf](https://github.com/Vagelis1608/piko/commit/b9612bfc69656681f3b84d0c8837e5d3dad9bc0d))
* **twitter:** Add google ads patch ([152b118](https://github.com/Vagelis1608/piko/commit/152b118737f84ebc155377ca58c7131486bad8a9))
* **twitter:** Add remove view count patch ([e31f222](https://github.com/Vagelis1608/piko/commit/e31f22278e6a5704037f3e3ed1583c25025abed8))
* **twitter:** Add selectable text patch ([ee3bcf1](https://github.com/Vagelis1608/piko/commit/ee3bcf17900dfe549a07426182a2149bcf16f87a))
* **Twitter:** Add settings for `Hide FAB` patch ([d5dde7c](https://github.com/Vagelis1608/piko/commit/d5dde7cb2e843bb0c8b90b7d1d5989bcf91e712b))
* **Twitter:** Add Settings for `Hide Live Threads` and `Hide Banner` patch ([ca474d4](https://github.com/Vagelis1608/piko/commit/ca474d4e7a1baa5f9cfcfd03a0640a4867089131))
* **Twitter:** Add Settings for `Hide Recommended Users` patch ([f43f027](https://github.com/Vagelis1608/piko/commit/f43f027ef6ab0d5ab0bc3433762e9200a3d8e50d))
* **Twitter:** Add settings for `Remove view count` patch ([67bb8ad](https://github.com/Vagelis1608/piko/commit/67bb8ad9837bdc21c2fffcad7851e67a8e37054d))
* **twitter:** Add Show sensitive media patch ([21c3fb4](https://github.com/Vagelis1608/piko/commit/21c3fb429b82acfb3a6b497c06c2a4e2ad596a9f))
* **Twitter:** Added 'Native reader mode'  patch ([308e1e6](https://github.com/Vagelis1608/piko/commit/308e1e6ae392eb6c0b9ade6383957fd2983e68f5))
* **Twitter:** Added `Ability to copy video media link` patch ([14bfdc7](https://github.com/Vagelis1608/piko/commit/14bfdc7d0b2d1fbf6644e496cbc186bd5ade3494))
* **Twitter:** Added `App Icon and NavBar Customisation` settings ([7e67d2f](https://github.com/Vagelis1608/piko/commit/7e67d2f84049007fe0b836567fd5572ad62b8a43))
* **Twitter:** Added `Backup and restore` section ([4d894f4](https://github.com/Vagelis1608/piko/commit/4d894f4686feb1bf3c2e2973b8fe3e986e1af22c))
* **Twitter:** Added `Change app icon` patch ([efbd6f7](https://github.com/Vagelis1608/piko/commit/efbd6f708357d0256104e31748a035d92acee8f4))
* **Twitter:** Added `Control video auto scroll` patch ([7a21924](https://github.com/Vagelis1608/piko/commit/7a21924dc7f30a15feef1797b0416c91de27d1e4))
* **Twitter:** Added `Custom downloader` ([3d5941e](https://github.com/Vagelis1608/piko/commit/3d5941e226c1fb9402edeeb138c1c974026e0598))
* **Twitter:** Added `Custom translator` patch ([737fb9e](https://github.com/Vagelis1608/piko/commit/737fb9eaa0b8da7f020b93c314f5da60f961e345))
* **Twitter:** Added `Customise font` patch ([e02d7db](https://github.com/Vagelis1608/piko/commit/e02d7dbd884ac4daf7c113d44575d085ba792989))
* **Twitter:** Added `Customise post font size` patch ([ea608e0](https://github.com/Vagelis1608/piko/commit/ea608e09b7b0775f38ca1914503e1b54dc7b73f9))
* **Twitter:** Added `Customize explore tabs` patch ([4be6a7f](https://github.com/Vagelis1608/piko/commit/4be6a7fe6ace42ca299d2e4bc7f9a963774f3bcd))
* **Twitter:** Added `Customize Inline action Bar items` patch ([05b06f9](https://github.com/Vagelis1608/piko/commit/05b06f9fa4a183c9626acc7fda69c0bebdbae761))
* **Twitter:** Added `Customize Navigation Bar items` patch ([9c6f59c](https://github.com/Vagelis1608/piko/commit/9c6f59cf6f40cc4d4d61b13bf496f800f452c0c1))
* **Twitter:** Added `Customize notification tabs` patch ([2e902e9](https://github.com/Vagelis1608/piko/commit/2e902e92b8cc56e757235cf47bbd6a52151b8c17))
* **Twitter:** Added `Customize reply sort filter` patch ([121b8a6](https://github.com/Vagelis1608/piko/commit/121b8a6e9345ea462ad9cb06f7b20f863fc08d4a))
* **Twitter:** Added `Customize search suggestions` patch ([aaca565](https://github.com/Vagelis1608/piko/commit/aaca565c650d6cf4b2cbb8abf2e206efe9983cb1))
* **Twitter:** Added `Customize search tab items` patch ([9edc97a](https://github.com/Vagelis1608/piko/commit/9edc97a89e61f28a5cd9a419d167a6c51a1a9816))
* **Twitter:** Added `Customize side bar items` patch ([ca0d28f](https://github.com/Vagelis1608/piko/commit/ca0d28f96d65d7d7f300f6089029ec24e55802b4))
* **Twitter:** Added `Customize timeline top bar` patch ([245c5f6](https://github.com/Vagelis1608/piko/commit/245c5f6f8f82e98b405ec853624c3cad52ae1764))
* **Twitter:** Added `Debug Menu` patch ([7d5ca77](https://github.com/Vagelis1608/piko/commit/7d5ca77bf633a8dfcd8657d12b24bd076b2f5d11))
* **Twitter:** Added `Delete from database` patch ([d785660](https://github.com/Vagelis1608/piko/commit/d7856602786d3fb9d7a8721f05d80be97bc4fd3b))
* **Twitter:** Added `Disable auto timeline scroll on launch` patch ([b8d431e](https://github.com/Vagelis1608/piko/commit/b8d431ea44a2b53f9065c226116d86ec1fb7b70f))
* **Twitter:** Added `Disunify xchat system` patch ([1fa9b7b](https://github.com/Vagelis1608/piko/commit/1fa9b7bb949152f536e95d801ded61ead21caac1))
* **Twitter:** Added `Enable app downgrading` patch ([9f581ce](https://github.com/Vagelis1608/piko/commit/9f581ce41b202fe7e5dfbb634a18a5bf6fb8faa5))
* **Twitter:** Added `Enable force HD videos` patch ([d316612](https://github.com/Vagelis1608/piko/commit/d3166121ac39adf45440e6888b43487e398f61e6))
* **Twitter:** Added `Enable PiP mode automatically` patch ([59d6b67](https://github.com/Vagelis1608/piko/commit/59d6b6723cbff6fa96218fb6210e2cb0b8bc1338))
* **Twitter:** Added `Feature Flag Hook` ([2328baf](https://github.com/Vagelis1608/piko/commit/2328baf92c733cf99ca364c978514b14b6aae2e0))
* **Twitter:** Added `Hide badges from navigation bar icons` patch ([1d98886](https://github.com/Vagelis1608/piko/commit/1d988863d06418e270d2821e366a5fdf1f3c0d47))
* **Twitter:** Added `Hide bookmark icon in timeline` ([ff66167](https://github.com/Vagelis1608/piko/commit/ff66167e5678adff4fde4e092a03b030a2a49693))
* **Twitter:** Added `Hide Buy Premium Banner` patch ([7ba6419](https://github.com/Vagelis1608/piko/commit/7ba64198f289ffac2e3d397e5bf0f1137ba2aa2b))
* **Twitter:** Added `Hide community badges` patch ([57936a1](https://github.com/Vagelis1608/piko/commit/57936a167eb23eeb992ca39015149e71e04270c5))
* **Twitter:** Added `Hide Community Notes` to mod settings ([157a32b](https://github.com/Vagelis1608/piko/commit/157a32b1e9f24157ad81c2434206f6e13404bbc3))
* **Twitter:** Added `Hide followed by context` patch ([261e1d0](https://github.com/Vagelis1608/piko/commit/261e1d0156702a4a72105b430d50e59e88795198))
* **Twitter:** Added `Hide For You` in Mod Settings ([86ea20f](https://github.com/Vagelis1608/piko/commit/86ea20f7c4309de0fcae2ba8fa2fa47990290a5a))
* **Twitter:** Added `Hide hidden replies` patch ([431acc4](https://github.com/Vagelis1608/piko/commit/431acc435675002c7d9f068b4fc3ebade2487db3))
* **Twitter:** Added `Hide immersive player` patch ([a649652](https://github.com/Vagelis1608/piko/commit/a649652c982903ac29100933122db47e9ed86d17))
* **Twitter:** Added `Hide nudge button` patch ([ad27484](https://github.com/Vagelis1608/piko/commit/ad27484f4cc0d727cf07cb4f202c8ddd6b582d67))
* **Twitter:** Added `Hide post metrics` patch ([81627c2](https://github.com/Vagelis1608/piko/commit/81627c2e75abb98a5b42da42187b7d9918a0b46b))
* **Twitter:** Added `Hide Promoted Trends` to Mod Settings ([9d29f45](https://github.com/Vagelis1608/piko/commit/9d29f45ba67ab2d682afe466c2d30af8b3421975))
* **Twitter:** Added `Legacy share links` patch ([3b986b0](https://github.com/Vagelis1608/piko/commit/3b986b09d40195c0b0a6cc1eefef79a91a475673))
* **Twitter:** Added `Log server response` patch ([bff4363](https://github.com/Vagelis1608/piko/commit/bff4363a56386ec6e1c80f2a57bdc70a28827be6))
* **Twitter:** Added `Patch info` section ([7f794c3](https://github.com/Vagelis1608/piko/commit/7f794c3cc88b1fd1170f43589aaff356532bb9e4))
* **Twitter:** Added `Pause search suggestions` patch ([a5f3d8e](https://github.com/Vagelis1608/piko/commit/a5f3d8e87b19b61223b4959cdccb68630ceeea4e))
* **Twitter:** Added `Pause search suggestions` patch ([ddbdcfe](https://github.com/Vagelis1608/piko/commit/ddbdcfeda9418e83e4206101c9847e866e6a23a4))
* **Twitter:** Added `Profile tabs customisation` ([db0298b](https://github.com/Vagelis1608/piko/commit/db0298b9f0cc6066974630d29812a2e8a11e7262))
* **Twitter:** added `Reader Mode patch` ([1348099](https://github.com/Vagelis1608/piko/commit/134809970363b6eb76b15f1c76b779307a663cc6))
* **Twitter:** Added `Remove main event` patch ([806598d](https://github.com/Vagelis1608/piko/commit/806598d7154c538fb238f3d9b186746cb8c956bf))
* **Twitter:** Added `Remove premium upsell` patch ([37525de](https://github.com/Vagelis1608/piko/commit/37525de868c38254cbfd20b58d4fd077b0c14ca2))
* **Twitter:** Added `Remove search suggestions` patch ([33fa525](https://github.com/Vagelis1608/piko/commit/33fa5257b2d0ff0ce5423db6df733202e705aac0))
* **Twitter:** Added `Remove search suggestions` patch ([dd8e67b](https://github.com/Vagelis1608/piko/commit/dd8e67b3a634036e308a2a99844c7c966f69890b))
* **Twitter:** Added `Remove Todays news` patch ([8324633](https://github.com/Vagelis1608/piko/commit/8324633509fdf61756751fdde67e5752ff3dee5c))
* **Twitter:** Added `Remove top people in search` patch ([95b5ef9](https://github.com/Vagelis1608/piko/commit/95b5ef902e6f595093b2304e5b2a8189f273389c))
* **Twitter:** Added `Remove videos for you` patch ([25934a2](https://github.com/Vagelis1608/piko/commit/25934a2b58a8eefc05d4313b623580371d964a12))
* **Twitter:** Added `Round off numbers` patch ([b1c1b13](https://github.com/Vagelis1608/piko/commit/b1c1b1361b55f08e2eba64e086943b30b2dc1212))
* **Twitter:** Added `Show changelogs` patch ([4b3adf7](https://github.com/Vagelis1608/piko/commit/4b3adf7a5e8966bc800d41b947349fb36345d5f4))
* **Twitter:** Added `Show post source label` patch ([931bc76](https://github.com/Vagelis1608/piko/commit/931bc762c3fc03535bf427b3e691f09e76271c85))
* **Twitter:** Added `Undo Post Patch` in mod settings ([54c722e](https://github.com/Vagelis1608/piko/commit/54c722e409e3367a9a1e42a7c51878ba81c3aa98))
* **Twitter:** added `Undo Posts Patch` ([ced73c6](https://github.com/Vagelis1608/piko/commit/ced73c6e316dbbdfaa60858ae5bc8a75b9afc3c0))
* **Twitter:** Added ability to export and import prefs & feature flags ([01cdd6b](https://github.com/Vagelis1608/piko/commit/01cdd6b7b25f08a3b258704f38c25b11aa1a9703))
* **Twitter:** Added ability to export and import prefs & feature flags ([a591133](https://github.com/Vagelis1608/piko/commit/a591133381a0b620a82d83580757300042680c85))
* **Twitter:** Added ability to reset pref and flags ([4aaeb09](https://github.com/Vagelis1608/piko/commit/4aaeb09ce6c38c6513be6293140a7e7e0b796f28))
* **Twitter:** Added Ad block hooks ([4811584](https://github.com/Vagelis1608/piko/commit/4811584abfb764c3539733818cf1d2dc96ef1349))
* **Twitter:** Added new source for `Native translator` ([6945434](https://github.com/Vagelis1608/piko/commit/69454343db3550ebba427d29ecbf1c0614cc94ec))
* **Twitter:** Added Remember filter for `Customize reply sort filter` ([24df398](https://github.com/Vagelis1608/piko/commit/24df3987e5008aeca52c11a8b20714766cdafff1))
* **Twitter:** Added tab redirects hook (for Bookmark Navbar) ([f01b418](https://github.com/Vagelis1608/piko/commit/f01b418fcc13e9fe54d845eab3bea1cd62687f9f))
* **Twitter:** Allow choosing public folder ([6c36202](https://github.com/Vagelis1608/piko/commit/6c362027f608ea2a84407d681d9b47775ccb0f4d))
* **Twitter:** Custom deeplinks ([325a281](https://github.com/Vagelis1608/piko/commit/325a281225b1379b310d8ba14629bdbae0b314e5))
* **Twitter:** Disable in favor of official patch bundle ([9a81fab](https://github.com/Vagelis1608/piko/commit/9a81fabed7457d1be967250faa548a67accc27bc))
* **Twitter:** Hide `Pinned posts by followers` ([5807471](https://github.com/Vagelis1608/piko/commit/5807471dda09eb379337f55edd650be12e66ff57))
* **Twitter:** Hide Banner ([b653c84](https://github.com/Vagelis1608/piko/commit/b653c84d4992be90386ce3e9031b138a4310b9fa))
* **Twitter:** Hide Community Notes ([ab48b40](https://github.com/Vagelis1608/piko/commit/ab48b402009c8603bd9ad9507a444742642282df))
* **Twitter:** Hide FAB ([4cdf50f](https://github.com/Vagelis1608/piko/commit/4cdf50fb036ed8596c9e4a3e3f1702ae78525d28))
* **Twitter:** Hide FAB Menu Buttons ([4f25bd6](https://github.com/Vagelis1608/piko/commit/4f25bd60888b70ccd4518a42459583b6ef8fcc54))
* **Twitter:** Hide For You ([c18f143](https://github.com/Vagelis1608/piko/commit/c18f1437882d6aba85c076a198a1a3c87067b716))
* **Twitter:** Hide Live Threads ([0202771](https://github.com/Vagelis1608/piko/commit/0202771020f97c32370d9ee7d110399eae6c264c))
* **Twitter:** Hide Promoted Trends ([1be736e](https://github.com/Vagelis1608/piko/commit/1be736e31ae11d21a62f7a3f4aad2689647ada92))
* **Twitter:** Hide Recommended Users ([2a55292](https://github.com/Vagelis1608/piko/commit/2a55292f81cd2d6f06058c8b4f347016700695eb))
* **Twitter:** Partial support to 11.91.xx ([6dbca75](https://github.com/Vagelis1608/piko/commit/6dbca754d3cfa0cd7aa9826c261b197f534a82f4))
* **Twitter:** support custom deeplink hosts ([499cc5e](https://github.com/Vagelis1608/piko/commit/499cc5ea3e32d3e6d551755df2f94b7dbc3da9af))
* **ui:** app wide monet theming in light mode ([46f920b](https://github.com/Vagelis1608/piko/commit/46f920bd35841e3df85617aed6a439f0df114d7b))
* **ui:** full app wide material theming in dim mode replacing dark blue ([52d7444](https://github.com/Vagelis1608/piko/commit/52d74441f0ae509ec66ba04b3939c90deb4755c5))
* Update README.md ([7d801a9](https://github.com/Vagelis1608/piko/commit/7d801a983d7f36eeba927514a26d943e0ea371d5))
* use browser chooser when opening links ([cc165f4](https://github.com/Vagelis1608/piko/commit/cc165f41db4392d9dcc554ee8800333e87dc8cdf))

### 🔧 Improvements

* **Bring back twitter:** Optimize string replacement ([#440](https://github.com/Vagelis1608/piko/issues/440)) ([7e61023](https://github.com/Vagelis1608/piko/commit/7e6102351d9488f89489f87df2ec45d6d0d178d8))
